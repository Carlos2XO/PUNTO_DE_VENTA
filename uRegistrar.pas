    ...
    begin
      ...
      begin
        ...
        begin
          ...
          frmLogin.tblUsuario.FieldByName('nombre').Value := ENombre.Text;
          frmLogin.tblUsuario.FieldByName('apellidoP').Value := EApellidoP.Text;
          frmLogin.tblUsuario.FieldByName('apellidoM').Value := EApellidoM.Text;
          frmLogin.tblUsuario.FieldByName('telefono').Value := ETel.Text;
          frmLogin.tblUsuario.FieldByName('correo').Value := ECorreo.Text;
